...
export function TrainingPrograms({ userRole }: TrainingProgramsProps) {
  ...
  const handleSave = async () => {
    try {
      const payload = {
        ...newProgram,
        cost: Number(newProgram.cost),
        participant: Number(newProgram.participant),
      };
      ...
      setPrograms(await fetchTrainingPrograms());
    } catch (err) {
  ...
  return (
    <div className="p-8 space-y-6">
          ...
          <>
            <Dialog open={modalOpen} onOpenChange={setModalOpen}>
              ...
              <DialogContent className="bg-[#fbfffe] rounded-xl">
                <DialogHeader>
                  <DialogTitle className="text-[#f46036]">
                    Add Training Program
                  </DialogTitle>
                </DialogHeader>
                <div className="space-y-4">
                  <input
                    ...
                    className="w-full px-3 py-2 rounded border border-[#6d676e]/30 focus:border-[#f46036] focus:ring-[#f46036] text-[#1b1b1e] bg-white"
                  />
                  <textarea
                    name="description"
                    ...
                    className="w-full px-3 py-2 rounded border border-[#6d676e]/30 focus:border-[#f46036] focus:ring-[#f46036] text-[#1b1b1e] bg-white min-h-[80px]"
                  />
                  <input
                    name="city"
                ...
                <DialogFooter>
                  <Button
                    className="bg-[#f46036] text-white font-bold px-4 py-2 rounded-lg hover:bg-[#d94e1f]"
                    onClick={handleSave}
                  >
                    Save
                  </Button>
      ...
      {loading ? (
        <div className="text-center text-[#f46036] py-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {programs.map((program) => (
            <Card
              ...
              className="bg-[#fbfffe] border-[#6d676e]/20 hover:shadow-lg transition-shadow"
            >
              <CardHeader>
              ...
              <CardContent className="space-y-4">
                <p className="text-[#1b1b1e] text-sm line-clamp-3">
                  {program.description}
                </p>
                <div className="space-y-2">
                  ...
                  <div className="flex items-center space-x-2 text-sm text-[#6d676e]">
                    ...
                    <span>
                      {program.age_range ? `${program.age_range} years` : "N/A"}
                    </span>
                  </div>
                  <div className="flex items-center space-x-2 text-sm text-[#6d676e]">
                  ...
                  <div className="flex items-center space-x-2 text-sm text-[#6d676e]">
                    ...
                    >
                      {program.cost === 0
                        ? "Free"
                        : `Rp ${program.cost.toLocaleString()}`}
                    </span>
                  </div>
                </div>
                <Button className="w-full bg-[#f46036] hover:bg-[#f46036]/90 text-white font-medium">
                  View Details
                </Button>
              </CardContent>
            </Card>
